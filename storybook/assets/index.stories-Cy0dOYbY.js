import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as ke,a as Ce,u as ye,g as Le,b as we,o as je,d as Fe}from"./reactHookFormUtils-DBL7F8xI.js";import{e as Te}from"./index-DTOEHpHZ.js";import{S as t}from"./index-ao8YK7Gr.js";import{B as We}from"./index-BIqEzyda.js";const Ee={title:"Components/Forms/Switch",component:t},s={args:{}},l={args:{checked:!0}},o={args:{label:"Label"}},n={args:{label:"Label",checked:!0}},i={args:{label:"Label",text:"This is an optional text",checked:!0}},c={args:{label:"Label",text:"This is an optional text",fullWidth:!0}},d={args:{label:"Label",labelSide:"right"}},u={args:{label:"Label",labelSide:"right",text:"This is an optional text"}},h={args:{label:"Label",text:"This is an optional text",fullWidth:!0,labelSide:"right"}},m={args:{label:"Label",text:"This is an optional text",disabled:!0}},p={args:{label:"Label",text:"This is an optional text",disabled:!0,defaultChecked:!0}},b={args:{label:"Label",text:"This is an optional text",state:"error",defaultChecked:!0}},g={args:{label:"Label",text:"This is an optional text",state:"success",defaultChecked:!0}},f={render:()=>{const[a,W]=Te.useState(!1);return e.jsxs("div",{children:[e.jsxs("div",{className:"clr-gray-900",children:["Value: ",JSON.stringify(a)]}),e.jsx(t,{checked:a,onChange:k=>W(k.target.checked)}),e.jsx(We,{onClick:()=>W(!a),children:"Toggle"})]})}},x={render:()=>e.jsx("form",{children:e.jsxs("div",{style:{width:"300px"},children:[e.jsx(t,{label:"Energy efficiency",fullWidth:!0,text:"Increases power by 15%"}),e.jsx(t,{label:"Battery percentage",fullWidth:!0,defaultChecked:!0}),e.jsx(t,{label:"Wi-Fi",fullWidth:!0,defaultChecked:!0}),e.jsx(t,{label:"Bluetooth",fullWidth:!0}),e.jsx(t,{label:"VPN",fullWidth:!0,text:"You must pay for this feature",state:"error",disabled:!0})]})})},S={render:()=>e.jsx("form",{children:e.jsxs("div",{style:{width:"300px"},children:[e.jsx(t,{label:"Energy efficiency",fullWidth:!0,labelSide:"right",text:"Increases power by 15%"}),e.jsx(t,{label:"Battery percentage",fullWidth:!0,defaultChecked:!0,labelSide:"right"}),e.jsx(t,{label:"Wi-Fi",fullWidth:!0,defaultChecked:!0,labelSide:"right"}),e.jsx(t,{label:"Bluetooth",fullWidth:!0,labelSide:"right"}),e.jsx(t,{label:"VPN",defaultChecked:!0,fullWidth:!0,labelSide:"right",text:"You must pay for this feature",state:"error",disabled:!0})]})})},r=()=>{const a=ke().shape({terms:Ce().required().oneOf([!0],"You have to accept the terms of use")}),{register:W,handleSubmit:k,formState:C}=ye({defaultValues:{terms:!1},mode:"onChange",reValidateMode:"onChange",resolver:Fe(a)});return e.jsxs("form",{style:{display:"flex",flexDirection:"column",gap:"1rem",width:"400px"},onSubmit:k(je),children:[e.jsx(t,{label:"I accept the terms of use",fullWidth:!0,state:we("terms",C),text:Le("terms",C),...W("terms")}),e.jsx(We,{fullWidth:!0,children:"Log-in"})]})};r.__docgenInfo={description:"",methods:[],displayName:"ReactHookForm"};var y,L,w;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {}
  ...
  render: () => {
    return <form>
        ...
        width: "300px"
          ...
          <Switch label="VPN" defaultChecked={true} fullWidth={true} labelSide="right" text="You must pay for this feature" state="error" disabled={true} />
        </div>
      </form>;
  }
