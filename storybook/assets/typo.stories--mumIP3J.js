import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{t as a}from"./cunningham-tokens-CoVatsL5.js";const g={title:"Misc/Spacings"},n={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:Object.keys(a.themes.default.globals.font.sizes).map(e=>s.jsxs("div",{className:"clr-content-semantic-neutral-primary fs-"+e,children:["Using the ",s.jsxs("code",{children:["fs-",e]})," class"]},e))})},r={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:Object.keys(a.themes.default.globals.font.weights).map(e=>s.jsxs("div",{className:"clr-content-semantic-neutral-primary fs-l fw-"+e,children:["Using the ",s.jsxs("code",{children:["fw-",e]})," class"]},e))})},t={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:Object.keys(a.themes.default.globals.font.families).map(e=>s.jsxs("div",{className:"clr-content-semantic-neutral-primary f-"+e,children:["Using the ",s.jsxs("code",{children:["f-",e]})," class"]},e))})};var l,c,i;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      display: "flex",
