...
| SelectMultiAuxProps["downshiftReturn"]`,elements:[{name:'SelectAuxProps["downshiftReturn"]',raw:'SelectAuxProps["downshiftReturn"]'},{name:'SelectMultiAuxProps["downshiftReturn"]',raw:'SelectMultiAuxProps["downshiftReturn"]'}]},description:""}},composes:["PropsWithChildren"]};function K(n){return e=>{var r;return!n||e.label.toLowerCase().includes(n.toLowerCase())||((r=e.value)==null?void 0:r.toLowerCase().includes(n.toLowerCase()))}}const j=n=>n?n.label:"",y=n=>n.value??n.label,C=(n,e)=>y(n)===y(e),W=n=>B(n)?n.render():n.label,L=({children:n,state:e="default",options:r,name:t,label:d,hideLabel:u,variant:l="floating",placeholder:i,labelAsPlaceholder:m,downshiftProps:v,downshiftReturn:o,value:s,disabled:f,clearable:R=!0,onBlur:g,...k})=>{const{t:b}=I(),p=o.getLabelProps(),S=c.useRef(null),x=l==="classic",ee=x&&!o.selectedItem&&i,H=a.jsxs("div",{className:"c__select__inner",children:[a.jsx("div",{className:"c__select__inner__value",children:ee?a.jsx("span",{className:"c__select__placeholder",children:i}):n}),a.jsxs("div",{className:"c__select__inner__actions",children:[R&&!f&&o.selectedItem&&a.jsxs(a.Fragment,{children:[a.jsx(N,{variant:"tertiary",color:"neutral",size:"nano","aria-label":b("components.forms.select.clear_button_aria_label"),className:"c__select__inner__actions__clear",onClick:q=>{o.selectItem(null),q.stopPropagation()},icon:a.jsx("span",{className:"material-icons","aria-hidden":"true",children:"close"}),type:"button"}),a.jsx("div",{className:"c__select__inner__actions__separator"})]}),a.jsx(N,{variant:"tertiary",color:"neutral",size:"nano","aria-label":b("components.forms.select.toggle_button_aria_label"),className:"c__select__inner__actions__open",icon:a.jsx("span",{className:h("material-icons",{opened:o.isOpen}),"aria-hidden":"true",children:"arrow_drop_down"}),disabled:f,type:"button",...o.toggleButtonProps})]})]});return a.jsxs(a.Fragment,{children:[a.jsx(E,{state:e,...k,children:a.jsxs("div",{ref:S,className:h("c__select","c__select--mono","c__select--"+e,{"c__select--disabled":f,"c__select--classic":x}),onBlur:()=>{var q;return g==null?void 0:g({target:{value:(q=o.selectedItem)==null?void 0:q.value}})},children:[x&&a.jsx(V,{label:d,hideLabel:u,disabled:f,className:"c__select__label",disabledClassName:"c__select__label--disabled",htmlFor:p.htmlFor,id:p.id}),a.jsxs("div",{className:h("c__select__wrapper",{"c__select__wrapper--focus":o.isOpen&&!f}),...o.wrapperProps,children:[o.selectedItem&&a.jsx("input",{type:"hidden",name:t,value:y(o.selectedItem)}),x?H:a.jsx(F,{label:d,hideLabel:u,variant:l,labelAsPlaceholder:m,htmlFor:p.htmlFor,labelId:p.id,disabled:f,children:H})]})]})}),a.jsx(A,{isOpen:o.isOpen,selectRef:S,downshiftReturn:o,children:a.jsxs("ul",{children:[r.map((q,P)=>{const ne=P===o.highlightedIndex;return a.jsx("li",{className:h("c__select__menu__item",{"c__select__menu__item--highlight":ne,"c__select__menu__item--selected":o.selectedItem&&C(o.selectedItem,q),"c__select__menu__item--disabled":q.disabled}),...o.getItemProps({item:q,index:P}),children:a.jsx("span",{children:W(q)})},`${y(q)}${P.toString()}`)}),r.length===0&&a.jsx("li",{className:"c__select__menu__item c__select__menu__empty-placeholder",children:b("components.forms.select.menu_empty_placeholder")})]})})]})};L.__docgenInfo={description:`This component is used by searchable and non-searchable select components.
It contains the common logic between the two.`,methods:[],displayName:"SelectMonoAux",props:{state:{required:!1,tsType:{name:"union",raw:"FieldState | undefined",elements:[{name:"union",raw:'"success" | "error" | "default"',elements:[{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"default"'}]},{name:"undefined"}]},description:"",defaultValue:{value:'"default"',computed:!1}},text:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},textItems:{required:!1,tsType:{name:"union",raw:"string[] | undefined",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"undefined"}]},description:""},rightText:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},fullWidth:{required:!1,tsType:{name:"union",raw:"boolean | undefined",elements:[{name:"boolean"},{name:"undefined"}]},description:""},compact:{required:!1,tsType:{name:"union",raw:"boolean | undefined",elements:[{name:"boolean"},{name:"undefined"}]},description:""},className:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},label:{required:!0,tsType:{name:"string"},description:""},hideLabel:{required:!1,tsType:{name:"boolean"},description:""},variant:{required:!1,tsType:{name:"union",raw:'"floating" | "classic"',elements:[{name:"literal",value:'"floating"'},{name:"literal",value:'"classic"'}]},description:"",defaultValue:{value:'"floating"',computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:""},options:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"OptionWithoutRender | OptionWithRender",elements:[{name:"intersection",raw:`Omit<BaseOption, "value" | "render"> & {
  ...
  highlightedIndex: number;
  wrapperProps?: HTMLAttributes<HTMLDivElement>;
}`,signature:{properties:[{key:"isOpen",value:{name:"boolean",required:!0}},{key:"getLabelProps",value:{name:"any",required:!0}},{key:"toggleButtonProps",value:{name:"any",required:!0}},{key:"getMenuProps",value:{name:"any",required:!0}},{key:"getItemProps",value:{name:"any",required:!0}},{key:"highlightedIndex",value:{name:"number",required:!0}},{key:"wrapperProps",value:{name:"HTMLAttributes",elements:[{name:"HTMLDivElement"}],raw:"HTMLAttributes<HTMLDivElement>",required:!1}}]}},description:""},useMultipleSelectionReturn:{required:!0,tsType:{name:"ReturnType",elements:[{name:"useMultipleSelection"}],raw:"ReturnType<typeof useMultipleSelection<Option>>"},description:""}}};const J=({ref:n,...e})=>{const[r,t]=T.useState(),d=c.useRef(null),u=T.useMemo(()=>e.options.filter(z(e.selectedItems,r)),[e.selectedItems,r]),[l,i]=c.useState(!1),m=w({selectedItems:e.selectedItems,onStateChange({selectedItems:g,type:k}){switch(k){case w.stateChangeTypes.SelectedItemKeyDownBackspace:case w.stateChangeTypes.SelectedItemKeyDownDelete:case w.stateChangeTypes.DropdownKeyDownBackspace:case w.stateChangeTypes.FunctionRemoveSelectedItem:e.onSelectedItemsChange(g??[]);break}}}),v=_({items:u,itemToString:j,defaultHighlightedIndex:0,selectedItem:null,stateReducer:(g,k)=>{const{changes:b,type:p}=k;switch(p){case _.stateChangeTypes.InputKeyDownEnter:case _.stateChangeTypes.ItemClick:return{...b,isOpen:!0,highlightedIndex:0};default:return b}},onStateChange:({inputValue:g,type:k,selectedItem:b})=>{switch(k){case _.stateChangeTypes.InputKeyDownEnter:case _.stateChangeTypes.ItemClick:case _.stateChangeTypes.InputBlur:b&&!b.disabled&&(e.onSelectedItemsChange([...e.selectedItems,b]),t(void 0));break;case _.stateChangeTypes.InputChange:t(g);break}},isItemDisabled:g=>!!(g!=null&&g.disabled)}),o=v.getInputProps({...m.getDropdownProps({onFocus:()=>{i(!0),v.openMenu()},onBlur:()=>{i(!1)},onChange:g=>{t(g.target.value)},size:4,preventKeyAction:v.isOpen,ref:d,disabled:e.disabled}),value:r}),{onKeyDown:s}=o;o.onKeyDown=g=>{switch(g.code){case"Backspace":r||e.onSelectedItemsChange(e.selectedItems.slice(0,-1))}s==null||s(g)};const[f,R]=c.useState(!0);return c.useEffect(()=>{if(l||r){R(!1);return}R(e.selectedItems.length===0)},[e.selectedItems,l,r]),c.useImperativeHandle(n,()=>({blur:()=>{var g;v.closeMenu(),(g=d.current)==null||g.blur()}})),c.useEffect(()=>{var g;(g=e.onSearchInputChange)==null||g.call(e,{target:{value:r}})},[r]),a.jsx(D,{...e,monoline:!1,options:u,labelAsPlaceholder:f,selectedItems:e.selectedItems,downshiftReturn:{...v,wrapperProps:{onClick:()=>{var g;(g=d.current)==null||g.focus(),v.isOpen||v.openMenu()}},toggleButtonProps:v.getToggleButtonProps()},useMultipleSelectionReturn:m,children:a.jsx("span",{className:"c__select__inner__value__input","data-value":r,children:a.jsx("input",{...o})})})};J.__docgenInfo={description:"",methods:[{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"SelectMultiSearchable",props:{onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: { target: { value: string[] } }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ target: { value: string[] } }",signature:{properties:[{key:"target",value:{name:"signature",type:"object",raw:"{ value: string[] }",signature:{properties:[{key:"value",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]},required:!0}}]}},name:"event"}],return:{name:"void"}}},description:""},onSelectedItemsChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(selectedItems: Option[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"union",raw:"OptionWithoutRender | OptionWithRender",elements:[{name:"intersection",raw:`Omit<BaseOption, "value" | "render"> & {
  value?: string;
  render?: undefined;
}`,elements:[{name:"Omit",elements:[{name:"signature",type:"object",raw:`{
  value: string;
