...
| "warning"
| "error"
| "success"`,elements:[{name:"literal",value:'"brand"'},{name:"literal",value:'"neutral"'},{name:"literal",value:'"info"'},{name:"literal",value:'"success"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"error"'},{name:"literal",value:'"success"'}],required:!1}},{key:"variant",value:{name:"union",raw:'"primary" | "secondary" | "tertiary" | "bordered"',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"secondary"'},{name:"literal",value:'"tertiary"'},{name:"literal",value:'"bordered"'}],required:!1}},{key:"icon",value:{name:"ReactNode",required:!1}},{key:"iconPosition",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!1}},{key:"active",value:{name:"boolean",required:!1}},{key:"fullWidth",value:{name:"boolean",required:!1}}]}}]},description:""},disableAnimate:{required:!1,tsType:{name:"boolean"},description:""},actions:{required:!1,tsType:{name:"ReactNode"},description:""}},composes:["PropsWithChildren"]};_.__docgenInfo={description:"",methods:[],displayName:"ProgressBar",props:{duration:{required:!0,tsType:{name:"number"},description:""}}};class R{push(n){const a=async()=>(this.lastJob&&await this.lastJob,n());return this.lastJob=a(),this.lastJob}}const A=m.createContext(void 0),O=()=>{const e=r.useContext(A);if(e===void 0)throw new Error("useToastProvider must be used within a ToastProvider.");return e};let v=1;const P=6e3,y=()=>parseInt(M.themes.default.components.toast["slide-in-duration"].replace("ms",""),10),k=({children:e})=>{const n=r.useRef(null),a=r.useRef(0),[l,o]=m.useState([]),d=r.useRef(new R),u=r.useMemo(()=>({toast:(i,c=T.NEUTRAL,s={})=>{var p;(p=d.current)==null||p.push(()=>new Promise(g=>{const L=v;v+=1,a.current=n.current.offsetHeight,o(E=>[...E,{...s,message:i,i:L,type:c,duration:(s==null?void 0:s.duration)??P}]),setTimeout(()=>{g()},y())}))}}),[n,a,l]),f=async()=>{if(!n.current)return;const i=a.current,s=n.current.offsetHeight-i;typeof n.current.animate=="function"&&!h()&&n.current.animate([{transform:`translateY(${s}px)`},{transform:"translateY(0)"}],{duration:y(),easing:"ease"})};return m.useEffect(()=>{f()},[v]),t.jsxs(A.Provider,{value:u,children:[e,t.jsx("div",{className:"c__toast__container",ref:n,children:l.map(i=>t.jsx(b,{onDelete:()=>{o(c=>c.filter(s=>s.i!==i.i))},...i,children:i.message},i.i))})]})};k.__docgenInfo={description:"",methods:[],displayName:"ToastProvider"};export{_ as P,b as T,T as V,k as a,N as i,O as u};
