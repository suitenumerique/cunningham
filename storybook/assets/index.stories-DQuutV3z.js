import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as c}from"./index-DTOEHpHZ.js";import{P as r,u as g}from"./index-CrUKKOux.js";const v={title:"Components/Pagination",component:r},n=()=>{const e=g({defaultPagesCount:100,defaultPage:50});return a.jsx(r,{...e})},o=()=>{const e=c.useMemo(()=>Array.from(Array(100).keys()),[]),[p,T]=c.useState([]),t=g({pageSize:10});return c.useEffect(()=>{const u=setTimeout(()=>{t.setPagesCount(Math.ceil(e.length/t.pageSize)),T(e.slice((t.page-1)*t.pageSize,t.page*t.pageSize))},500);return()=>{clearTimeout(u)}},[t.page]),a.jsxs("div",{children:[a.jsx("div",{children:p.map(u=>a.jsx("div",{className:"p-t bg-semantic-neutral-tertiary mb-t",children:u},u))}),a.jsx(r,{...t})]})},s=()=>{const e=g({defaultPagesCount:10});return c.useEffect(()=>{const p=setTimeout(()=>{e.setPage(5)},500);return()=>{clearTimeout(p)}},[]),a.jsx(r,{...e})},i=()=>{const e=g({defaultPagesCount:100,defaultPage:50});return a.jsx(r,{...e,displayGoto:!1})};n.__docgenInfo={description:"",methods:[],displayName:"Basic"};o.__docgenInfo={description:"",methods:[],displayName:"List"};s.__docgenInfo={description:"",methods:[],displayName:"ForcePage"};i.__docgenInfo={description:"",methods:[],displayName:"WithoutGoto"};var m,d,l;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`() => {
  ...
  return <div>
      <div>
        {items.map(item => <div className="p-t bg-semantic-neutral-tertiary mb-t" key={item}>
            {item}
          </div>)}
      </div>
