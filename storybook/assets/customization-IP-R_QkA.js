import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as i}from"./index-DywkESLE.js";import"./index-e4yktitK.js";import{M as r,S as t}from"./index-rVOOaGJR.js";import"./index-DTOEHpHZ.js";import"./_commonjsHelpers-gnU0ypJ3.js";import"./preview-DyHeCVCW.js";import"./iframe-te6tvP2I.js";import"./DocsRenderer-CFRXHY34-CpnB6faG.js";import"./react-18-0ENLrOAf.js";import"./index-DO9VteM4.js";import"./index-D2FdBkVr.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";function s(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Getting Started/Customization"}),`
...
`,e.jsx(n.li,{children:"The brand color"}),`
...
`,e.jsxs(n.strong,{children:["You can find the default values ",e.jsx(n.a,{href:"https://github.com/suitenumerique/cunningham/blob/main/packages/tokens/src/bin/cunningham.ts",rel:"nofollow",children:"here"}),"."]})]}),`
...
`})}),`
`,e.jsx(n.p,{children:"Build your app again, and you should see the changes applied! 💄"}),`
`,e.jsxs(n.p,{children:["If you find out that the current design tokens are not enough for the customization you want to do, feel free to ",e.jsx(n.a,{href:"https://github.com/suitenumerique/cunningham/issues/new",rel:"nofollow",children:"open an issue"})," or to ",e.jsx(n.a,{href:"https://github.com/suitenumerique/cunningham/blob/main/CONTRIBUTING.md",rel:"nofollow",children:"contribute to the project"})," 🙏"]}),`
`,e.jsx(n.h2,{id:"use-default-design-tokens",children:"Use default design tokens"}),`
`,e.jsxs(n.p,{children:["If you want to use the default design tokens, you can import them from the ",e.jsx(n.code,{children:"@gouvfr-lasuite/cunningham-react"}),` package. For example,
...
`]}),`
`,e.jsxs(n.p,{children:["You can also use more global design tokens from ",e.jsx(n.code,{children:"defaultTokens.globals"})," and ",e.jsx(n.code,{children:"defaultTokens.contextuals"}),", like that:"]}),`
`,e.jsx(t,{dark:!0,code:`
// cunningham.ts
import { defaultTokens, DefaultTokens } from "@gouvfr-lasuite/cunningham-react";
...
const config: DefaultTokens = {
  themes: {
    default: {
      ...
      components: {
        button: {
          "medium-font-size": defaultTokens.globals.font.sizes.s,
          "color": defaultTokens.contextuals.content.semantic.brand.primary,
          "background-color": defaultTokens.contextuals.background.semantic.neutral.primary,
        },
      },
    },
  },
