...
describe("<TextArea/>", () => {
  ...
  describe("classic variant", () => {
    it("renders with classic variant", () => {
      render(<TextArea label="Description" variant={FieldVariant.Classic} />);
    ...
    it("label is always static in classic variant", async () => {
      ...
      render(
        <div>
          <TextArea label="Description" variant={FieldVariant.Classic} />
          <TextArea label="Notes" variant={FieldVariant.Classic} />
        </div>,
      );
